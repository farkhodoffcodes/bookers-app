...
const ContactInformationClient = ({ data }: any) => {
    ...
    const callPhone = () => Linking.openURL(`tel:${data.phoneNumber}`).catch((err) => console.error('Error:', err));
    const goInstagram = () => Linking.openURL(`https://www.instagram.com/${data.instagram}`).catch((err) => console.error('Error:', err));
    const goTelegram = () => Linking.openURL(`https://t.me/${data.telegram}`).catch((err) => console.error('Error:', err));
    return (
        <>
            ...
            <View style={styles.contactInfo}>
                ...
                {data && data.instagram && (
                    ...
                    >
                        ...
                        <Text style={styles.contactText}>{data.instagram}</Text>
                    </TouchableOpacity>
                )}
                {data && data.telegram && (
                    <TouchableOpacity
                    ...
                    >
                        ...
                        <Text style={styles.contactText}>{data.telegram}</Text>
                    </TouchableOpacity>
                )}
            </View>
...
export default ContactInformationClient;